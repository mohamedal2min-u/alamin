...
class StoreFlockRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'chick_paid_amount' => ['nullable', 'numeric', 'min:0'],
    ...
    public function messages(): array
    {
        return [
            ...
            'chick_paid_amount.numeric' => 'المبلغ المدفوع يجب أن يكون رقماً',
            'chick_paid_amount.min'     => 'المبلغ المدفوع لا يمكن أن يكون أقل من الصفر',
        ];
    }
}
